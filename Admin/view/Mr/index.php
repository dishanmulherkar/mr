                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="hq" id="hq" class="form-control" required>
                                            ...
                                            <?php if(isset($hq) && $hq): ?>
                                                <?php while($hqrow = mysqli_fetch_assoc($hq)): ?>
                                                    <option value="<?php echo htmlspecialchars($hqrow['headquarter_id']); ?>"
                                                        <?php if(isset($ROW['hq_id']) && $ROW['hq_id'] == $hqrow['headquarter_id']) echo 'selected'; ?>>
                                                        <?php echo htmlspecialchars($hqrow['hq_name']); ?>
                                                    </option>
                                                <?php endwhile; ?>
                                            <?php endif; ?>
                                        </select>
                            ...
                            <div class="box box-primary mt-3">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>User ID (HQ@rudradeo)</label>
                        ...
                        <table class="table" id="hqTable">
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                ...
                                <td class="text-center">
                                    <!-- Edit -->
                                    <a href="<?= BASE_URL ?>mr/edit/<?= $row['m_id']; ?>"
...
$(document).ready(function() {
    ...
    // On state change, load both District and HQ
