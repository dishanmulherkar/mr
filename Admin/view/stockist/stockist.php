...
<div id="container">
                    ...
                    <?php if(isset($_GET['success'])): ?>
                        <div class="alert alert-success">Stockist saved successfully!</div>
                    <?php endif; ?>
                    <?php if(isset($_GET['deleted'])): ?>
                        <div class="alert alert-info">Stockist deleted successfully!</div>
                    <?php endif; ?>
                    <?php if(isset($_GET['error'])): ?>
                        <div class="alert alert-danger">Something went wrong. Please try again.</div>
                    <?php endif; ?>
                    <?php if(isset($_GET['duplicate'])): ?>
                        <div class="alert alert-warning">Stockist name already exists!</div>
                    <?php endif; ?>

                    <h3><?php echo isset($ROW) ? 'Edit' : 'Add'; ?> Stockist</h3>

                    <!-- ==================  FORM  ================== -->
                    <form method="post" enctype="multipart/form-data"
                                    action="<?= isset($ROW)
                        ? BASE_URL.'stockist/update/'.$ROW['stockist_id']
                        : BASE_URL.'stockist/store'; ?>">


                        <!-- Preserve existing image on edit -->
                        <input type="hidden" name="existing_image"
                               value="<?php echo isset($ROW['stockist_image']) ? htmlspecialchars($ROW['stockist_image']) : ''; ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="stockist_name" class="form-control"
                                            ...
                                            value="<?php echo isset($ROW['stockist_name']) ? htmlspecialchars($ROW['stockist_name']) : ''; ?>"
                                            required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="py-2 px-3">
                                ...
                                <?php if(isset($ROW)): ?>
                                    <a href="<?= BASE_URL ?>stockist" class="btn btn-secondary btn-sm ml-2" style="width:130px;">Cancel</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <!-- ================  /FORM  ================ -->
                    <div class="mb-3">
                        <a href="<?= BASE_URL ?>stockist/downloadImages" class="btn btn-success btn-downoload">
