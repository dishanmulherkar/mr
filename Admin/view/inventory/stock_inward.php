...
<style>
 ...
 <div id="container">
                    <div class="detail">
         <a href="inward_report" class="btn btn-success btn-sm mr-3" style="margin-right: 10px;">
    View Inward
</a>
                    ...
                    <?php endif; ?>
                    <h3>Add Stock Inward</h3>
                    
                    <form method="post" action="<?= BASE_URL ?>stock_inward/store">
                        <div class="container border px-3 py-3 bg-white rounded">
                            <div class="row">
                               ...
                               <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Batch (Apply to All)</label>
...
function loadGlobalBatch(state_id)
{
    if(state_id=='')
    {
    ...
    $.ajax({
        ...
        url:'<?= BASE_URL ?>stock_inward/getStateBatches',
...
$('form').on('submit', function(e) {
    ...
    loadGlobalBatch(state_id);
    $.ajax({

        url:'<?= BASE_URL ?>stock_inward/getProductsByState',
    ...
    $('#state_id').change(function(){
        ...
        loadGlobalBatch(state_id); // Load global batches for the selected state
    });
