...
">
    <tr>
        ...
        <td style="
            ...
            padding: 2px;
            text-align: right;
        ">Original / Duplicate / Triplicate</td>
    </tr>
</table>
    <!-- Company Header -->
    ...
    <table style="border: 1px solid #000;">
        <tr style="vertical-align: top;">
            ...
            <td style="width: 75%; border-right: 1px solid #000;  padding: 0px 0; vertical-align: top;">
                <div style="font-weight: bold; font-size: 8pt; margin-bottom: 0px;"><?= htmlspecialchars($message) ?></div>
            ...
            <td  style="width: 75%;">
                    <table>
                            <tr style="font-weight: bold; ">
                                ...
                                <td style="border: none; padding: 0px 0px; font-size: 9pt; "> <?= htmlspecialchars($invoice['amount_words'] ?? 'Total Amount In Words') ?></td>
                            </tr>
                    </table>
            </td>
            <td style="width: 25%; ">
                <table>
                    <tr style="font-weight: bold; border-left: 1px solid #946b6b;  ">
                            <td style="border: none; padding: 0px 0px; font-size: 9pt; text-align: left;">Net Amount</td>
                            <td style="border: none; padding: 0px 0px; font-size: 9pt; text-align: right;"><?= number_format($netAmountRounded, 2) ?></td>
                        </tr>
                </table>
            </td>
        </tr>
        <tr >
            ...
            <td style="width: 25%;  padding-bottom: 50px;">
                        For, <?= htmlspecialchars($companyName) ?>
            </td>
        </tr>
        <tr style="margin-top:25px;">
             <td  style="width: 75%; margin-top:25px; ">
